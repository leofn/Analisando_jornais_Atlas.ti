...
```{r highcharterplot, echo=FALSE, fig.cap="<center><b> Fonte: <a href='https://rkabacoff.github.io/datavis/Interactive.html'>Adaptado de Datavis with R </a></b></center>", out.width="45%"}
...
---
class: middle, center
background: https://media0.giphy.com/media/5i7umUqAOYYEw/giphy-downsized.gif
...
.pull-left[
`r emo::ji("+1")` Como é uma apresentação elaborada com códigos, é possível utilizar o versionamento de código utilizando `Git` e `GitHub`, e possibilita o desenvolvimento do material em equipe.
